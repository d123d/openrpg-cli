...
from openrpg_cli.character import Character
from openrpg_cli.combat import CombatEvent, Outcome
from openrpg_cli.combat_rules import CreatureView
from openrpg_cli.combat_session import CombatSession
from openrpg_cli.dev import get_developer_backend
...
def render_report_markdown(report: PlaytestReport) -> str:
    ...
    lines = [
        f"# OpenRPG CLI Playtest: {report.run_id}",
        "",
