...
from openrpg_cli.data import SRDRepository, get_repository
...
MODELS: dict[str, type[Entity]] = {
    ...
    "DomainAction.json": DomainAction,
    "LegalCode.json": LegalCode,
    "StressTrigger.json": StressTrigger,
    "PanicResult.json": PanicResult,
    "SettlementType.json": SettlementType,
    "SettlementResource.json": SettlementResource,
}
