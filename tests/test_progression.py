import pytest
from srd_cli.rules.progression import build_progressions, level_for_xp, proficiency_bonus, validate_advancement
...
def test_advancement_contracts():
    ...
    with pytest.raises(ValueError): validate_advancement(1, 3, milestone=True)
