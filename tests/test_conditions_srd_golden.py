...
from srd_cli.rules.effects import CONDITION_REGISTRY, Condition


def test_all_condition_keys_match_corpus() -> None:
    rows = json.loads(Path("srd_cli/data/srd521/ConditionDescription.json").read_text(encoding="utf-8"))
